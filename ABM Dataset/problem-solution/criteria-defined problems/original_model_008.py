# Spread of virus and influence of economical development
import random
...
class Government:
    ...
    def calculate_GDP(self):
        self.gdp_loss = sum(person.is_employed*self.manual_productivity for person in self.people)/len(self.people)
        return self.gdp_loss
...
class Hospital:
    ...
    def admit_patient(self, people):
        ...
        for person in people:
            if person.is_infected():
                if len(self.patients) < self.capacity and not person.in_hospital:
