...
class Government:
    ...
    def accelerate_fire_extinguishing(self):
        for x in range(self.forest.size):
            for y in range(self.forest.size):
                if self.forest.grid[x][y].status == "Burning":
                    self.forest.grid[x][y].set_status("Healthy")
...
class simulation:
    ...
    def simulate(self, steps):
        for _ in range(steps):
            ...
            self.government.accelerate_fire_extinguishing()
